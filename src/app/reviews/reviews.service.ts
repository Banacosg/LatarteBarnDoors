...
export class ReviewsService {
  ...
  reviews: Review[] = [
    ...
    {
      photo: this.assetsPath + 'Face1.jpeg',
      name: 'Eva',
      stars: 4,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face2.jpeg',
      name: 'Diego',
      stars: 5,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face3.jpeg',
      name: 'Layla',
      stars: 4,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face4.jpeg',
      name: 'Sophie',
      stars: 5,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face5.jpeg',
      name: 'Kenji',
      stars: 4,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face6.jpeg',
      name: 'Marcela',
      stars: 5,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face7.jpeg',
      name: 'Liam',
      stars: 4,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face8.jpeg',
      name: 'Yuki',
      stars: 5,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face9.jpeg',
      name: 'Greta',
      stars: 4,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face10.jpeg',
      name: 'Amir',
      stars: 5,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face11.jpeg',
      name: 'Nikoleta',
      stars: 4,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face12.jpeg',
      name: 'Étienne',
      stars: 5,
      comment:
    ...
    {
      photo: this.assetsPath + 'Face13.jpeg',
      name: 'Jolene',
      stars: 4,
      comment:
